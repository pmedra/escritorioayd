...
{
    public partial class Actualizar_Estado_Pedido : Form
    {
        OperacionesFormulario operacionesformulario;
        MySqlConnection conexion;
        int indice;
        public Actualizar_Estado_Pedido(OperacionesFormulario operacionesformulario, MySqlConnection conexion, int indice)
        {
            InitializeComponent();
        ...
        private void botonactualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    String query = "update estadopedido set descripcion = @name where idestadopedido = " + indice;
                    ...
                    String query = "update estadopedido set nombre = @name where idestadopedido = " + indice;
                    MySqlCommand cmd = new MySqlCommand();
                    cmd.CommandText = query;
                    cmd.Connection = conexion;
